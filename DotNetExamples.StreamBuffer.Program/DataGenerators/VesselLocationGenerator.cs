...
namespace DotNetExamples.StreamBuffer.Program.Generators
{
    ...
    /// </summary>
    public class VesselLocationGenerator : IDataGenerator<VesselLocation>
    {
        /// <summary>
        ...
        public VesselLocation Next()
        {
            ...
            {
                latitude = Coordinates.Latitude - (latitudeOffset * 2);
            }
            ...
            {
                longitude = Coordinates.Longitude - (longitudeOffset * 2);
            }

            return new VesselLocation(Name, DateTime.Now, new Coordinates(latitude, longitude));
        }
    }
}
